...
DISABLE_VENV_CD=1
plugins=(celery colored-man-pages django fabric heroku history-substring-search pip python redis-cli safe-paste ssh-agent tmux vagrant virtualenv zsh-syntax-highlighting)
