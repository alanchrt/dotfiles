...
# Mon 29 Jul 2019 02:54:12 AM CDT - Unknown packages
...
AddPackage hsetroot # Tool which allows you to compose wallpapers ("root pixmaps") for X
...
AddPackage libnsl # Public client interface library for NIS(YP) and NIS+
...
# Mon 29 Jul 2019 02:54:17 AM CDT - Unknown foreign packages
...
# Mon 29 Jul 2019 02:54:18 AM CDT - New files
